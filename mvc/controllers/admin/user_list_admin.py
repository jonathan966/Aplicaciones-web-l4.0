...
class User_list_admin:
    def GET(self):   
        try: # prueba el codigo
            ...
            users = db.child("usuario_creado").get() # se crea la variable email donde se guardara los datos ingresados en el formulario
            return render.user_list_admin(users) # se renderizara la pagina con la variable antes creada que es localid
